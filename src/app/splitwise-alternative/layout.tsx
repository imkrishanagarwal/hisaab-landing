...
export const metadata: Metadata = {
  ...
  description:
    'Looking for a free Splitwise alternative? The Hisaab offers unlimited groups, unequal splits, offline mode, and no ads — 100% free forever. Made for India. Download on Android & iOS.',
  alternates: {
