...
export default function SplitwiseAlternativePage() {
  return (
    <div className="min-h-screen bg-[#0B0B0B] text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger} className="text-center lg:text-left">
              ...
              <motion.p variants={fadeUp} className="text-lg text-gray-400 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                Hisaab is the best free alternative to Splitwise. Unlimited groups, unequal splits, multiple payers, offline mode &mdash; all free, no ads, made for India.
              </motion.p>
            ...
            >
              <div className="screenshot-phone animate-float-slow w-full max-w-xs mx-auto">
                <Image src="/ss/grouplist.webp" alt="Hisaab app - free Splitwise alternative showing group expenses" width={400} height={800} className="w-full h-auto" priority />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-[#121212]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: Ban, title: '3 expenses/day limit', desc: 'Splitwise free users can only add 3 expenses per day. Hisaab has no limits.', color: 'text-red-400 bg-red-500/10' },
              { icon: Zap, title: '10-second unskippable ads', desc: 'Splitwise forces you to watch ads before adding expenses. Hisaab has zero ads.', color: 'text-red-400 bg-red-500/10' },
              { icon: IndianRupee, title: '₹999/year for premium', desc: 'Splitwise Pro costs ₹999/year for features Hisaab gives you free.', color: 'text-red-400 bg-red-500/10' },
            ].map((item) => {
      ...
      <section className="py-16 sm:py-24 bg-[#0B0B0B]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={stagger} className="text-center mb-12">
            ...
            <motion.p variants={fadeUp} className="text-gray-400 text-lg max-w-2xl mx-auto">
              See why Hisaab is the better choice for splitting expenses in India.
            </motion.p>
          </motion.div>
      ...
      <section className="py-16 sm:py-24 bg-[#0B0B0B]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {[
              { src: '/ss/grouplist.webp', alt: 'Hisaab groups list - track all shared expenses' },
              { src: '/ss/add-exp.webp', alt: 'Add and split expenses in Hisaab' },
      ...
      <SeoPageFooter heading="Ditch the paywall." subheading="Switch to Hisaab — the free Splitwise alternative that actually stays free." />
    </div>
  );
}
