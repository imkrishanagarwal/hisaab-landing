...
export const metadata: Metadata = {
  ...
  description:
    'Split rent, groceries, electricity, WiFi, and all shared expenses with your roommates. The Hisaab tracks every rupee automatically. Free forever. No ads.',
  alternates: {
    canonical: 'https://thehisaab.com/for/roommates',
  },
  openGraph: {
    title: 'Roommate Expense Tracker - The Hisaab',
    ...
    images: [{ url: '/image.jpg', width: 1200, height: 630, alt: 'The Hisaab - Roommate Bill Splitting' }],
    locale: 'en_IN',
  },
  twitter: {
