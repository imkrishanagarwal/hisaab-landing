...
export const metadata: Metadata = {
  ...
  description:
    'Track shared expenses with your partner without awkward money conversations. Hisaab keeps things fair and transparent. Free. Private. Simple.',
  alternates: {
    canonical: 'https://thehisaab.com/for/couples',
  },
  openGraph: {
    title: 'Couple Expense Tracker - Hisaab',
    ...
    images: [{ url: '/image.jpg', width: 1200, height: 630, alt: 'Hisaab - Couple Expense Tracker' }],
    locale: 'en_IN',
  },
  twitter: {
