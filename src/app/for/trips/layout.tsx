...
export const metadata: Metadata = {
  ...
  description:
    'Split Goa trip expenses, vacation costs, and travel bills with friends easily. The Hisaab makes group trip expense splitting simple. Works offline. 100% free. No ads.',
  alternates: {
    canonical: 'https://thehisaab.com/for/trips',
  },
  openGraph: {
    title: 'Split Trip Expenses - The Hisaab',
    ...
    images: [{ url: '/image.jpg', width: 1200, height: 630, alt: 'The Hisaab - Split Trip Expenses' }],
    locale: 'en_IN',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Best Trip Expense Splitter - The Hisaab',
